<?php
	...
	if(isset($_SESSION['temp'])){		
		...
		$sql = mysql_query("SELECT * FROM empmonitoring WHERE EmpID='$empid'");
    ...
    <!-- left side start-->
		...
		<div class="main-content">
			...
			<div class="panel-body panel-body-inputin">
				<h3 class="blank1">Relieve Employee</h3>
				<form role="form" class="form-horizontal" action="relsuc.php" method="post">			
